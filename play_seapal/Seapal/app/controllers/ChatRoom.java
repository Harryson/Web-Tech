...
public class ChatRoom extends UntypedActor {
    ...
    HashMap<String, WebSocket.Out<JsonNode>> members = new HashMap<String, WebSocket.Out<JsonNode>>();
    ...
    public void onReceive(Object message) throws Exception {
        ...
        if(message instanceof Join) {
            ...
            if(members.containsKey(join.username)) {
                getSender().tell("Dieser Benutzername wird schon benutzt!");
            } else {
                members.put(join.username, join.channel);
                notifyAll("join", join.username, "hat den Chat-Room betreten");
                getSender().tell("OK");
            }
            ...
            notifyAll("quit", quit.username, "hat den Chat-Room verlassen");
